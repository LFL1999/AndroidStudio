...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btn_clr,btn_del,btn_eq,btn_his;
    EditText et_input,et_output0,et_output1,et_output2;
    boolean clr_flag;    //判断et编辑文本框中是否清空
    double his[]= {0.0,0.0,0.0};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_output0= (EditText) findViewById(R.id.et_output0);
        et_output1= (EditText) findViewById(R.id.et_output1);
        et_output2= (EditText) findViewById(R.id.et_output2);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.btn_eq: //单独运算最后结果
                ...
                break;
            case R.id.btn_his:
                et_output0.setText(his[0]+"");
                et_output1.setText(his[1]+"");
                et_output2.setText(his[2]+"");
                break;
        }
    }
    public void history(double res){
        his[0]=his[1];
        his[1]=his[2];
        his[2]=res;
    }
    private void getResult() {
        ...
        if(!s1.equals("")&&!s2.equals("")){
            ...
            cnt=(double) Math.round(cnt * 10000) / 10000;
        ...
        //如果s1是空    s2不是空  就执行下一步
            ...
            cnt=(double) Math.round(cnt * 100) / 100;
            if(!s1.contains(".")) {
                int res = (int) cnt;
                et_input.setText(res+"");
            }else {
